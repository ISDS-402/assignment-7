...
INSERT INTO SEMINAR VALUES(
	'12-OCT-2016', '11:00 AM', 'San Antonio Convention Center',
	'Kitchen on a Budget');
INSERT INTO SEMINAR VALUES(
	'26-OCT-2016', '04:00 PM', 'Dallas Convention Center',
	'Kitchen on a Big D Budget');
INSERT INTO SEMINAR VALUES(
	'02-NOV-2016', '08:30 AM', 'Austin Convention Center',
	'Kitchen on a Budget');
INSERT INTO SEMINAR VALUES(
	'22-MAR-2017', '11:00 AM', 'Dallas Convention Center',
	'Kitchen on a Big D Budget');
INSERT INTO SEMINAR VALUES(
	'23-MAR-2017', '11:00 AM', 'Dallas Convention Center',
	'Kitchen on a Big D Budget');
INSERT INTO SEMINAR VALUES(
	'05-APR-2017', '08:30 AM', 'Austin Convention Center',
	'Kitchen on a Budget');
...
INSERT INTO CONTACT VALUES(1, 1, '12-OCT-2016', 'Seminar', 1);
-- 'Chantel.Jacobs@somewhere.com'
INSERT INTO CONTACT VALUES(2, 1, '12-OCT-2016', 'Seminar', 1);
-- 'Ralph.Able@somewhere.com'
INSERT INTO CONTACT VALUES(3, 1, '12-OCT-2016', 'Seminar', 1);
-- 'Susan.Baker@elsewhere.com'
INSERT INTO CONTACT VALUES(4, 1, '12-OCT-2016', 'Seminar', 1);
-- 'Sam.Eagleton@elsewhere.com'
INSERT INTO CONTACT VALUES(5, 1, '12-OCT-2016', 'Seminar', 1);

-- 'Nancy.Jacobs@somewhere.com',
INSERT INTO CONTACT (CustomerID, ContactNumber, ContactDate,  ContactType)
	VALUES(1, 2, '15-OCT-2016', 'EmailSeminarMessage');
-- 'Chantel.Jacobs@somewhere.com'
INSERT INTO CONTACT (CustomerID, ContactNumber, ContactDate,  ContactType)
	VALUES(2, 2, '15-OCT-2016', 'EmailSeminarMessage');
-- 'Ralph.Able@somewhere.com'
INSERT INTO CONTACT (CustomerID, ContactNumber, ContactDate,  ContactType)
	VALUES(3, 2, '15-OCT-2016', 'EmailSeminarMessage');
-- 'Susan.Baker@elsewhere.com'
INSERT INTO CONTACT (CustomerID, ContactNumber, ContactDate,  ContactType)
	VALUES(4, 2, '15-OCT-2016', 'EmailSeminarMessage');
-- 'Sam.Eagleton@elsewhere.com'
INSERT INTO CONTACT (CustomerID, ContactNumber, ContactDate,  ContactType)
	VALUES(5, 2, '15-OCT-2016', 'EmailSeminarMessage');


-- 'Nancy.Jacobs@somewhere.com',
INSERT INTO CONTACT (CustomerID, ContactNumber, ContactDate,  ContactType)
	VALUES(1, 3, '15-OCT-2016', 'FormLetterSeminar');
-- 'Chantel.Jacobs@somewhere.com'
INSERT INTO CONTACT (CustomerID, ContactNumber, ContactDate,  ContactType)
	VALUES(2, 3, '15-OCT-2016', 'FormLetterSeminar');
-- 'Ralph.Able@somewhere.com'
INSERT INTO CONTACT (CustomerID, ContactNumber, ContactDate,  ContactType)
	VALUES(3, 3, '15-OCT-2016', 'FormLetterSeminar');
-- 'Susan.Baker@elsewhere.com'
INSERT INTO CONTACT (CustomerID, ContactNumber, ContactDate,  ContactType)
	VALUES(4, 3, '15-OCT-2016', 'FormLetterSeminar');
-- 'Sam.Eagleton@elsewhere.com'
INSERT INTO CONTACT (CustomerID, ContactNumber, ContactDate,  ContactType)
	VALUES(5, 3, '15-OCT-2016', 'FormLetterSeminar');

-- 'Kathy.Foxtrot@somewhere.com'
INSERT INTO CONTACT VALUES(6, 1, '26-OCT-2016', 'Seminar', 2);
-- 'Sally.George@somewhere.com'
INSERT INTO CONTACT VALUES(7, 1, '26-OCT-2016', 'Seminar', 2);
-- 'Shawn.Hullett@elsewhere.com'
INSERT INTO CONTACT VALUES(8, 1, '26-OCT-2016', 'Seminar', 2);

-- 'Kathy.Foxtrot@somewhere.com'
INSERT INTO CONTACT (CustomerID, ContactNumber, ContactDate,  ContactType)
	VALUES(6, 2, '30-OCT-2016', 'EmailSeminarMessage');
-- 'Sally.George@somewhere.com'
INSERT INTO CONTACT (CustomerID, ContactNumber, ContactDate,  ContactType)
	VALUES(7, 2, '30-OCT-2016', 'EmailSeminarMessage');
-- 'Shawn.Hullett@elsewhere.com'
INSERT INTO CONTACT (CustomerID, ContactNumber, ContactDate,  ContactType)
	VALUES(8, 2, '30-OCT-2016', 'EmailSeminarMessage');

-- 'Kathy.Foxtrot@somewhere.com'
INSERT INTO CONTACT (CustomerID, ContactNumber, ContactDate,  ContactType)
	VALUES(6, 3, '30-OCT-2016', 'FormLetterSeminar');
-- 'Sally.George@somewhere.com'
INSERT INTO CONTACT (CustomerID, ContactNumber, ContactDate,  ContactType)
	VALUES(7, 3, '30-OCT-2016', 'FormLetterSeminar');
-- 'Shawn.Hullett@elsewhere.com'
INSERT INTO CONTACT (CustomerID, ContactNumber, ContactDate,  ContactType)
	VALUES(8, 3, '30-OCT-2016', 'FormLetterSeminar');

-- 'Bobbi.Pearson@elsewhere.com'
INSERT INTO CONTACT VALUES(9, 1, '02-NOV-2016', 'Seminar', 3);
-- 'Terry.Ranger@somewhere.com'
INSERT INTO CONTACT VALUES(10, 1, '02-NOV-2016', 'Seminar', 3);

-- 'Bobbi.Pearson@elsewhere.com'
INSERT INTO CONTACT (CustomerID, ContactNumber, ContactDate,  ContactType)
	VALUES(9, 2, '06-NOV-2016', 'EmailSeminarMessage');
-- 'Terry.Ranger@somewhere.com'
INSERT INTO CONTACT (CustomerID, ContactNumber, ContactDate,  ContactType)
	VALUES(10, 2, '06-NOV-2016', 'EmailSeminarMessage');

-- 'Bobbi.Pearson@elsewhere.com'
INSERT INTO CONTACT (CustomerID, ContactNumber, ContactDate,  ContactType)
	VALUES(9, 3, '06-NOV-2016', 'FormLetterSeminar');
-- 'Terry.Ranger@somewhere.com'
INSERT INTO CONTACT (CustomerID, ContactNumber, ContactDate,  ContactType)
	VALUES(10, 3, '06-NOV-2016', 'FormLetterSeminar');


-- 'Ralph.Able@somewhere.com'
INSERT INTO CONTACT (CustomerID, ContactNumber, ContactDate,  ContactType)
	VALUES(3, 4, '20-FEB-2017', 'WebAccountCreation');
-- 'Ralph.Able@somewhere.com'
INSERT INTO CONTACT (CustomerID, ContactNumber, ContactDate,  ContactType)
	VALUES(3, 5, '20-FEB-2017', 'EmailAccountMessage');
-- 'Kathy.Foxtrot@somewhere.com'
INSERT INTO CONTACT (CustomerID, ContactNumber, ContactDate,  ContactType)
	VALUES(6, 4, '22-FEB-2017', 'WebAccountCreation');
-- 'Kathy.Foxtrot@somewhere.com'
INSERT INTO CONTACT (CustomerID, ContactNumber, ContactDate,  ContactType)
	VALUES(6, 5, '22-FEB-2017', 'EmailAccountMessage');
-- 'Sally.George@somewhere.com'
INSERT INTO CONTACT (CustomerID, ContactNumber, ContactDate,  ContactType)
	VALUES(7, 4, '25-FEB-2017', 'WebAccountCreation');
-- 'Sally.George@somewhere.com'
INSERT INTO CONTACT (CustomerID, ContactNumber, ContactDate,  ContactType)
	VALUES(7, 5, '25-FEB-2017', 'EmailAccountMessage');
-- 'Shawn.Hullett@elsewhere.com'
INSERT INTO CONTACT (CustomerID, ContactNumber, ContactDate,  ContactType)
	VALUES(8, 4, '07-MAR-2017', 'WebAccountCreation');
-- 'Shawn.Hullett@elsewhere.com'
INSERT INTO CONTACT (CustomerID, ContactNumber, ContactDate,  ContactType)
	VALUES(8, 5, '07-MAR-2017', 'EmailAccountMessage');

-- 'Kathy.Foxtrot@somewhere.com'
INSERT INTO CONTACT VALUES(6, 6, '22-MAR-2017', 'Seminar', 4);
-- 'Sally.George@somewhere.com'
INSERT INTO CONTACT VALUES(7, 6, '22-MAR-2017', 'Seminar', 4);
-- 'Jenny.Tyler@somewhere.com'
INSERT INTO CONTACT VALUES(11, 1, '22-MAR-2017', 'Seminar', 4);
-- 'Joan.Wayne@elsewhere.com'
INSERT INTO CONTACT VALUES(12, 1, '22-MAR-2017', 'Seminar', 4);
...
INSERT INTO INVOICE VALUES(
	'15-Oct-2016', 3, 'VISA', 22.94, 5.95, 1.31, 30.20);
...
-- 'Susan.Baker@elsewhere.com'
INSERT INTO INVOICE VALUES(
	'25-Oct-2016', 4, 'MasterCard', 47.89, 5.95, 2.73, 56.57);
...
-- 'Sally.George@somewhere.com'
INSERT INTO INVOICE VALUES(
	'20-Dec-2016', 7, 'VISA', 24.95, 5.95, 1.42, 32.32);
INSERT INTO LINE_ITEM VALUES(35002, 1, 'VK004', 1, 24.95, 24.95);

/*****   Invoice 35003   **************************************************/
-- 'Susan.Baker@elsewhere.com'
INSERT INTO INVOICE VALUES(
	'25-Mar-2017', 4, 'MasterCard', 64.85, 5.95, 3.70, 74.50);
...
-- 'Kathy.Foxtrot@somewhere.com'
INSERT INTO INVOICE VALUES(
	'27-Mar-2017', 6, 'MasterCard', 94.79, 5.95, 5.40, 106.14);
...
-- 'Sally.George@somewhere.com'
INSERT INTO INVOICE VALUES(
	'27-Mar-2017', 7, 'MasterCard', 94.80, 5.95, 5.40, 106.15);
...
-- 'Bobbi.Pearson@elsewhere.com'
INSERT INTO INVOICE VALUES(
	'31-Mar-2017', 9, 'VISA', 47.89,	5.95, 2.73, 56.57);
...
-- 'Jenny.Tyler@somewhere.com'
INSERT INTO INVOICE VALUES(
	'03-Apr-2017', 11, 'MasterCard', 109.78, 5.95, 6.26, 121.99);
...
-- 'Sam.Eagleton@elsewhere.com'
INSERT INTO INVOICE VALUES(
	'08-Apr-2017', 5, 'MasterCard', 47.89, 5.95, 2.73, 56.57);
...
-- 'Nancy.Jacobs@somewhere.com'
INSERT INTO INVOICE VALUES(
	'08-Apr-2017', 1, 'VISA', 47.89,	5.95, 2.73, 56.57);
...
-- 'Ralph.Able@somewhere.com'
INSERT INTO INVOICE VALUES(
	'23-Apr-2017', 3, 'VISA', 24.95,	5.95, 1.42, 32.32);
INSERT INTO LINE_ITEM VALUES(35010, 1, 'BK001', 1, 24.95, 24.95);

/*****   Invoice 35011   ***************************************************/
-- 'Bobbi.Pearson@elsewhere.com'
INSERT INTO INVOICE VALUES(
	'07-May-2017', 9, 'VISA', 22.94,	5.95, 1.31, 30.20);
...
-- 'Shawn.Hullett@elsewhere.com'
INSERT INTO INVOICE VALUES(
	'21-May-2017', 8, 'MasterCard', 54.89, 5.95, 3.13, 63.97);
...
-- 'Ralph.Able@somewhere.com'
INSERT INTO INVOICE VALUES(
	'05-Jun-2017', 3, 'VISA', 47.89,	5.95, 2.73, 56.57);
...
-- 'Jenny.Tyler@somewhere.com'
INSERT INTO INVOICE VALUES(
	'05-Jun-2017', 11, 'MasterCard', 45.88, 5.95, 2.62, 54.45);
...
-- 'Joan.Wayne@elsewhere.com'
INSERT INTO INVOICE VALUES(
	'05-Jun-2017', 12, 'MasterCard', 94.79, 5.95, 5.40, 106.14);
...
-- 'Ralph.Able@somewhere.com'
INSERT INTO INVOICE VALUES(
	'05-Jun-2017', 3, 'VISA', 45.88,	5.95, 2.62, 54.45);
